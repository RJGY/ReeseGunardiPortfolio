                                ...
                                <Col sm={9}>
                                    <Tab.Content>
                                        <Tab.Pane eventKey="first">
                                            ...
                                            <p className="fs-5">Developing an ever evolving web application which is used by thousands of customers. Designed and developed backend systems by creating robust CRUD API endpoints and architecting new features, ensuring seamless integration with frontend components. Leveraged frontend expertise to implement user-focused features. Led a small team to explore and implement cutting-edge AI technologies, successfully integrating them into the product to drive innovation and enhance functionality.</p> 
                                        </Tab.Pane>
                                        <Tab.Pane eventKey="second">
                                            <p className="fs-3">Test Automation Engineer & Junior Developer</p>
                                            <p className="fs-5">Created automated tests in Java with Spring Boot with Gherkin feature files which test the functional and performance capabilities of mutliple systems. I also worked part time as a junior developer where I developed new microservices which report the transactions which occur on the Australian Share Market. I also assisted in the development of inhouse tools such as our testing framework and mapping document register which displays the relationship of all the microservices and how they interact with each other.</p>
                                        </Tab.Pane>
